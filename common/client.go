...
func (defaultClient DefaultClient) GetResponse(path string, clinetInfo model.ClinetInfo, bizData model.BizData) string{
...
type IAliYunClient interface {
	GetResponse(path string, clinetInfo model.ClinetInfo, bizData model.BizData) string
}
